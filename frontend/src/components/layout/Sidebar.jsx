...
const navItems = [
  ...
  { path: '/scheduler', icon: Calendar, label: 'Scheduler', soon: true },
  { path: '/inbox', icon: Inbox, label: 'Inbox', soon: true },
      ...
      <nav className="flex-1 p-3 space-y-1 overflow-y-auto">
        {navItems.map((item) => (
          ...
          >
            ...
            {item.soon && !collapsed && (
              <span className="ml-auto text-[10px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-full bg-slate-100 text-slate-400">
                Soon
              </span>
            )}
          </NavLink>
